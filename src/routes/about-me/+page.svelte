...
<div class="text-column">
	...
	<ul>
		...
		<li>C# CLI data pipeline chron job</li>
		<li>Large (10+k rows) jquery data tables</li>
	...
	<ul>
		...
		<li>Establishing frontend ownership/responsibilities</li>
		<li>Influence API design</li>
		<li>Facilitate discussions on technology choices</li>
	</ul>
</div>
